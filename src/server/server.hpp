...
void parseAndRun(Command cmd, std::string buf, int len, Client client, Parameters *params, bool verbose, std::unordered_map<std::string, Player> &players);

void run_rsg(Parameters *params, std::unordered_map<std::string, Player> &players);
